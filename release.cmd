...
IF EXIST "./bin/%kks_name%/BepinEx/plugins/%kks_name%.dll" "%ProgramFiles%\7-Zip\7z.exe" a -tzip "%HOMEPATH%/downloads/%kks_name% v%kks_version%.zip" "./bin/%kks_name%/BepinEx" -mx0
