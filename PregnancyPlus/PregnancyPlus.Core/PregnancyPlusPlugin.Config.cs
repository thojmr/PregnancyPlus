...
namespace KK_PregnancyPlus
{
    public partial class PregnancyPlusPlugin
    {
        ...
        {            
            ...
            StoryModeInflationMoveY = Config.Bind<float>(storyConfigTitle, "Global Move Y", 0, 
            ...
            StoryModeInflationMoveZ = Config.Bind<float>(storyConfigTitle, "Global Move Z", 0, 
            ...
            StoryModeInflationStretchX = Config.Bind<float>(storyConfigTitle, "Global Stretch X", 0, 
            ...
            StoryModeInflationStretchY = Config.Bind<float>(storyConfigTitle, "Global Stretch Y", 0, 
            ...
            StoryModeInflationShiftY = Config.Bind<float>(storyConfigTitle, "Global Shift Y", 0, 
            ...
            StoryModeInflationTaperZ = Config.Bind<float>(storyConfigTitle, "Global Taper Z", 0, 
