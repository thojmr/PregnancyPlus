...
namespace KK_PregnancyPlus
{
    ...
    {           
        ...
        internal Tuple<Vector3, bool> SculptInflatedVerticie(
            PregnancyPlusData infConfigClone, Vector3 originalVerticeLs, Vector3 inflatedVerticieLs, Vector3 sphereCenterLs, float waistWidth, 
            ...
            await Task.Run(() => 
            {
                ...
                Threading.RunParallel(sourceNormals, (_, i) => 
                {
                    ...
                    if (alteredVerts[i])
                    {
                        ...
                        //Get normal deltas, dont rotate normals, they are already corrected in RecalculateNormals
